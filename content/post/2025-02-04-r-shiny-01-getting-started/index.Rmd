...
featuredImage: "01_Shiny_web_app.webp"
categories:
  - R-shiny
tags: []
---
...
<div style="text-align: center;">
  <img src="01_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="02_1_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="02_2_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="03_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 1
</div>
...
<div style="text-align: center;">
  <img src="04_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 2
</div>
...
<div style="text-align: center;">
  <img src="05_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 3
</div>
...
<div style="text-align: center;">
  <img src="06_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 4
</div>
...
<div style="text-align: center;">
  <img src="07_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 5
</div>
...
<div style="text-align: center;">
  <img src="08_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 6
</div>
...
<div style="text-align: center;">
  <img src="09_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 7
</div>
...
<div style="text-align: center;">
  <img src="10_Shiny_web_app.webp" class="centered-img" onclick="openModal(this.src)">
  <br>
  Figure 8
</div>
