...
featuredImage: "01_SmokeTool_tutorial_gam_manual_gam_setup.webp"
categories:
  - SmokeTool-tutorial
tags: []
---
...
<div style="text-align: center;">
  <img src="01_SmokeTool_tutorial_gam_manual_gam_setup.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="02_SmokeTool_tutorial_gam_manual_gam_setup.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="03_SmokeTool_tutorial_gam_manual_gam_setup.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="04_SmokeTool_tutorial_gam_manual_gam_setup.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="05_SmokeTool_tutorial_gam_manual_gam_setup.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="06_SmokeTool_tutorial_gam_manual_gam_setup.webp" class="centered-img" onclick="openModal(this.src)">
</div>
