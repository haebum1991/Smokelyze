...
featuredImage: "01_SmokeTool_tutorial_gam_previous_layer_map.webp"
categories:
  - SmokeTool-tutorial
tags: []
---
...
<div style="text-align: center;">
  <img src="01_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="02_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="03_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="04_1_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="04_2_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="04_3_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="04_4_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="05_SmokeTool_tutorial_gam_previous_layer_map.webp" class="centered-img" onclick="openModal(this.src)">
</div>
