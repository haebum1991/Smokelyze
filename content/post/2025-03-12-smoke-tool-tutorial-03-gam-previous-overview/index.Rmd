...
featuredImage: "01_SmokeTool_tutorial_gam_previous_overview.webp"
categories:
  - SmokeTool-tutorial
tags: []
---
...
<div style="text-align: center;">
  <img src="01_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="02_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="03_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="04_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="05_1_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="05_2_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="05_3_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>

<div style="text-align: center;">
  <img src="05_4_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="06_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
...
<div style="text-align: center;">
  <img src="07_SmokeTool_tutorial_gam_previous_overview.webp" class="centered-img" onclick="openModal(this.src)">
</div>
